          ...
          <div className="container">
            <div className="row">
              <div className="col-xl-9 mx-auto">
                <h1 className="mb-5">
                  Online Test Series & Free Mock Tests For Competitive Exams
                  in India
                </h1>
                <h5>
                  Boost your exam preparation with Testbook to crack the
                  most popular competitive exams in India. Select your
...
>>>>>>> b8dbca6749513be6d4d3d40e488c99723a54878d
          </div>
        </header>
                ...
                <div className="card">
                  ...
                  <div classNames="card-body">
                    ...
                    <p className="card-text">
                      Study Materials, Mock Tests, Live tests and much
                      more..
                    </p>
                  </div>
                </div>
          ...
          <div className="container-fluid p-0">
            <div className="row no-gutters">
              ...
              <div className="col-lg-6 order-lg-1 my-auto showcase-text">
                ...
                <p className="lead mb-0">
                  Every question, every solution, meticulously created by
                  our team of toppers and experts, based on the latest exam
                  patterns. The mock tests are the closest exam experience
                  you will find to the actual paper.
                </p>
              </div>
            </div>
            <div className="row no-gutters">
            ...
            <div className="row no-gutters">
              ...
              <div className="col-lg-6 order-lg-1 my-auto showcase-text">
                ...
                <p className="lead mb-0">
                  We know about how precious your time is. Get the advantage
                  of the latest technology to kickstart your exam
                  preparation and get the finest learning experience - on
                  Website and App. Check them all out!
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="row">
              <div className="col-lg-4">
                <div className="testimonial-item mx-auto mb-5 mb-lg-0">
                  <img className="img-fluid rounded-circle mb-3" src={require("../img/noimage.jpg")} alt="" />
                  <h5>User1</h5>
